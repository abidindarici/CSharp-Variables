...
Console .WriteLine(g);
double h = 9.548785; //Float data type has a minimum value of 1.7 - 308 and a maximum value of 1.7 + 308.
Console .WriteLine (h);
string name_surname = "Abidin Darici";
